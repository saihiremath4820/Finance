        ...
        <div className="bg-gray-900 p-8 rounded-3xl text-white shadow-2xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white">Risk Score Drivers</h2>
                        <p className="text-gray-400 text-xs mt-1">Key factors influencing the current risk assessment</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <div className="text-xs font-medium text-gray-500">
                        Source: TrustVault Analytics Engine
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    <div className="bg-white/5 border border-white/5 p-6 rounded-2xl">
                        <h4 className="text-lg font-bold text-brand-blue-400 mb-2">Risk Factor Analysis</h4>
